    ...
    return (
        <div style={{backgroundImage: `url('${bgPicture}'`}}>
            <Container className="text-center d-flex align-items-center justify-content-center vh-100">
                <Form ref={formRef} className="form-signin shadow-lg p-3 mb-5 bg-white rounded" onSubmit={handleSubmit}>
                    <img
                        className="mb-4"
                        src={`${icon}`}
                        alt=""
                    ...
                    <p className="mt-2">
                        Don't have an account? <Link to="/registration" className="fw-bold">Create a new account.</Link>
                    </p>
